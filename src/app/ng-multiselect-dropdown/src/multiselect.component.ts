...
export class MultiSelectComponent implements ControlValueAccessor, DoCheck {
  ...
  customSelectItemsBoolean = this.selectedItems.length > 0;
  customSelectItemsLessBoolean = this.selectedItems.length < 0;
  ...
  ngDoCheck() {
    this.customSelectItemsBoolean = this.selectedItems.length > 0;
    this.customSelectItemsLessBoolean = this.selectedItems.length < 0;
  }
  ...
  customisAllItemsSelected(): boolean {
